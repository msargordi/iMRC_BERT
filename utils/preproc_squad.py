...
# srl_predictor = Predictor.from_path("../projects/rrg-bengioy-ad/maziar/imrc_storage/bert-base-srl-2020.03.24.tar.gz")
...
# for split in ["train", "valid", "test"]:
#     processed_data = process_file("squad_split/extended/extended_squad.1.1.split." + split + ".json")
#     with codecs.open("squad_split/extended/extended_processed_squad.1.1.split." + split + ".json", 'w', encoding='utf-8') as json_file:
#         json.dump({"data": processed_data}, json_file, ensure_ascii=False)